    ...
    try:
        while True:
            ...
            for symbol in SYMBOLS:
                ...
                if quote and quote.get("c", 0) > 0:
                    ...
                    if current_t != last_seen_t[symbol]:
                        ...
                        print(
                            f"✅ Published: {symbol} @ ${quote['c']} (ID: {future.result()})"
                        )
                    else:
            ...
            if not current_cycle_has_new_data:
                duplicate_streak += 1
                print(
                    f"⚠️ No price movement detected for any symbol. Streak: {duplicate_streak}/10"
                )
            else:
            ...
            if duplicate_streak >= 10:
                ...
                time.sleep(
                    3600
                )  # Sleep for 60 minutes before checking the market again
